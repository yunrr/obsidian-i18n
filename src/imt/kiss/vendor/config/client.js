/**
 * @file client.js
 * @description 客户端类型常量定义模块，区分 Web、浏览器扩展（Chrome, Edge, Firefox, Thunderbird）、油猴脚本（Userscript）以及 Obsidian 插件环境。
 * [obsidian-i18n 移植补丁] 新增 CLIENT_OBSIDIAN 客户端标识。
 */
...
export const CLIENT_OBSIDIAN = "obsidian"; // Obsidian 插件环境 (obsidian-i18n 移植)
