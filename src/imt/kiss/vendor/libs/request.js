...
import { obsidianFetch } from "../../adapters/obsidian-fetch";
...
export const fetchPatcher = async (input, init = {}, opts) => {
  ...
  // [obsidian-i18n] Obsidian 渲染进程直接 fetch 受 CORS 限制，统一走 requestUrl 适配器
  if (isObsidian) {
    return obsidianFetch(input, requestInit);
  }
