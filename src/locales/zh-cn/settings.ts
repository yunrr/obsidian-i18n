...
export default {
    ...
    Basis: {
        ...
        TranslationVersionTitle: "默认译文版本",
        TranslationVersionDesc: "新建译文时写入 metadata.version 的默认版本号。",
        // 自动化任务
        AutoApplyTitle: "自动应用",
    ...
    Re: {
        ...
        ProfileDelBtn: "删除",
        ProfileAddTitle: "新增 RE 配置",
        ProfileCopyTitle: "复制 RE 配置",
        ProfileRenameTitle: "重命名 RE 配置",
        ProfileAddNotice: "配置已创建",
    ...
    Ast: {
        ...
        ProfileRenameBtn: "重命名",
        ProfileDelBtn: "删除",
        ProfileAddTitle: "新增 AST 配置",
        ProfileCopyTitle: "复制 AST 配置",
        ProfileRenameTitle: "重命名 AST 配置",
        ProfileAddNotice: "配置已创建",
        ProfileDelConfirm: "删除后无法恢复，确认？",
        // ── 提取规则 ──
        ConfigHeader: "提取规则",
